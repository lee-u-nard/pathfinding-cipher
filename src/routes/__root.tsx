  ...
  head: () => ({
    meta: [
      ...
      { title: "SmartRoute — Pathfinding & Cryptography Visualizer" },
      {
        name: "description",
        content:
          "Watch A*, Dijkstra, Greedy Best-First and Floyd-Warshall race across a real map of the Philippines while RSA, AES-GCM and SHA-256 run step by step — all in your browser.",
      },
      { name: "author", content: "SmartRoute" },
